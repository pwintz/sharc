// controller/CarlaKinematicMPCController.h
#pragma once

#ifndef CARLA_KINEMATIC_MPC_CONTROLLER_H
#define CARLA_KINEMATIC_MPC_CONTROLLER_H
...
class CarlaKinematicMPCController : public Controller {
private:
...
public:
    CarlaKinematicMPCController(const nlohmann::json& json_data) : Controller(json_data) {
        setup(json_data);
    }
...
#endif // TNX == 4
#endif // CARLA_KINEMATIC_MPC_CONTROLLER_H
